...
const Menu = () => {
  ...
  return(
    <div className='w-full lg:w-1/5 lg:px-6 text-xl text-gray-800 leading-normal'>
       ...
       <div className='w-full sticky inset-0 h-64 lg:h-auto overflow-x-hidden overflow-y-auto lg:overflow-y-hidden lg:block mt-0 border border-gray-400 lg:border-transparent bg-white shadow lg:shadow-none lg:bg-transparent z-20' id='menu-content'>
